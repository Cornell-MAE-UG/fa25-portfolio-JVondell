...
<img src="{{ '/assets/images/actuator-diagram.jpeg' | relative_url }}" width="500" alt="Actuator Diagram">
...
<img src="{{ '/assets/images/part-one.jpeg' | relative_url }}" width="500" alt="Part One">
...
<img src="{{ '/assets/images/part-two.jpeg' | relative_url }}" width="500" alt="Part Two">
